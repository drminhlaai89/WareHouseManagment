            ...
            <div class="row">
             ...
             <thead class="thead-light">
                <tr role="row">
                    ...
                    <th style="width: 100px;"> Status Transaction</th>
             ...
             <tr role="row">
                ...
                <td>
                    <a href="{{url('return/export/create')}}/{{$exports->exportid}}" class="btn btn-info text-light" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Select">
