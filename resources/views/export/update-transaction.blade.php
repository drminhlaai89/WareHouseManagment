                ...
                <div class="col-lg-12">
                     <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <select class="browser-default custom-select" name="exportstatus_transaction">
                        ...
                        <div style="padding-left:40%">
                            ...
                            if($export->exportstatus_order == 1) {
                                echo ('<button type="button" class="btn btn-warning"><a class="text-white" href="/export/update/'.$export->exportid.'/cancel-shipping">Cancel Shipping</a></button>');
