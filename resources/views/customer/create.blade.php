                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input class="form-control" name="txtname" placeholder="Customer Name" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>Type</label>
                                        <textarea type="text" class="form-control" rows="3" name ="txtdescription" placeholder="Type" ></textarea>
                                    </div>
                                </div>
                            <div class="col-lg-2">
                                <div class="form-group">
