                ...
                @if ($user)     
                    ...
                    <tr role="row">
                        ...
                        @php
                                    ...
                                    @endphp
                        <td>
                            <a href="{{url('admin/detail')}}/{{$u->id}}" class="btn btn-info text-light" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View Profile">
                            <i class="mdi mdi-eye"></i>
                            </a>
                            <a href="{{url('admin/update')}}/{{$u->id }}" class="btn btn-primary text-light" data-toggle="tooltip" data-placement="bottom" data-original-title="Update Profile">
