<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled bg-secondary" id="sidebar">
    <ul class="nav">
        <li class="nav-item nav-profile not-navigation-link">
            <div class="nav-link">
                <div class="user-wrapper">
                    ...
                    <p class="profile-name">{{session()->get('user')->fullname}}</p>
                        <div class="dropdown" data-display="static">
                            ...
                            <a class="dropdown-item mt-2" href="/admin/detail/{{session()->get('user')->id}}"> Manage Accounts </a>
                                <a class="dropdown-item" href="/admin/changepassword/{{session()->get('user')->id}}"> Change Password </a>
                ...
                <button class="btn btn-outline-success"><a href="/admin/create">Tạo tài khoản mới</a> <i class="mdi mdi-plus"></i>
                </button>
            </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['account/*']) }}">
            <a class="nav-link" data-toggle="collapse" href="#account-pages">
                <i class="menu-icon mdi mdi-account-multiple"></i>
                <span class="menu-title">Account</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['user-pages/*']) }}" id="account-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item {{ active_class(['account']) }}">
                        <a class="nav-link" href="{{ url('/admin/listuser') }}">List Account</a>
                    </li>
                    <li class="nav-item {{ active_class(['account/create']) }}">
                        <a class="nav-link" href="{{ url('/admin/create') }}">Create new Account</a>
                    </li>
                    <li class="nav-item {{ active_class(['account/create']) }}">
                        <a class="nav-link" href="/admin/changepassword/{{session()->get('user')->id}}">Change Password</a>
                    </li>

                </ul>
            </div>
        </li>
        <li class="nav-item {{ active_class(['order-pages/*']) }}">
            <a class="nav-link" data-toggle="collapse" href="#order-pages" aria-expanded="{{ is_active_route(['order-pages/*']) }}" aria-controls="user-pages">
                <i class="menu-icon mdi mdi-note-text"></i>
                <span class="menu-title">Order List</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['order-pages/*']) }}" id="order-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item {{ active_class(['order-pages/register']) }}">
                        <a class="nav-link" href="{{ url('/admin/import/order-pending') }}">Import List</a>
                    </li>
                    <li class="nav-item {{ active_class(['order-pages/lock-screen']) }}">
                        <a class="nav-link" href="{{ url('/admin/export/order-pending') }}">Export List</a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['import/*']) }}">
            ...
            <div class="collapse {{ show_class(['import-pages/*']) }}" id="import-pages">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['import/create']) }}">
                        <a class="nav-link" href="{{ url('/import/create') }}">Return Import</a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item {{ active_class(['export/*']) }}">
            ...
            <div class="collapse {{ show_class(['export-pages/*']) }}" id="export-pages">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['export/create']) }}">
                        <a class="nav-link" href="{{ url('/export/create') }}">Return Export</a>
                    </li>
                </ul>
            </div>
